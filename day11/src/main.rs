...
impl Monkey {
    ...
    fn if_true(&mut self, to: usize) {
        self.if_true = to;
    }

    fn if_false(&mut self, to: usize) {
        self.if_false = to;
    }
    ...
    for line in lines {
        if line.starts_with("Monkey") {
            ...
            let to = line
                ...
                .unwrap();
            monkeys.last_mut().unwrap().if_true(to);
            ...
            let to = line
                ...
                .map(|d| d.parse::<usize>().unwrap())
                .unwrap();
            monkeys.last_mut().unwrap().if_false(to);
        }
    }
    monkeys
}
